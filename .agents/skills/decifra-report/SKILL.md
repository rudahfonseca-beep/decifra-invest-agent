---
name: decifra-report
description: Build decifra-invest-agent credit/equity research reports assemble local KPI context, pack an LLM prompt, optionally generate interactive HTML. Use for report smoke tests, spec validation, or Streamlit Report builder help.
---
