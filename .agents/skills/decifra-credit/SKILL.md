---
name: decifra-credit
description: Run decifra-invest-agent creditworthiness scoring and Streamlit dashboard. Use for industry peer scores, credit smoke tests, or metric/signal debugging.
---
