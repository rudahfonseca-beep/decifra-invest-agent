---
name: decifra-aar
description: Write decifra-invest-agent After Action Reports and refresh the human HTML session dashboard. Use at session end, handoff, or when the user asks for AAR / session documentation / dashboard update.
---
