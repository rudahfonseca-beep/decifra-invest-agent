---
name: decifra-sync
description: Run and QA decifra-invest-agent Ibovespa data collection (decifra sync / sync_pilot). Use when syncing universe, financials, notices, transcripts, checking coverage, or automating data collection.
---
